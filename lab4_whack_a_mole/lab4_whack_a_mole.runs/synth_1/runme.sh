...
HD_PWD='C:/Users/Student/Desktop/team_15_w24/lab4_whack_a_mole/lab4_whack_a_mole.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wam_m.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wam_m.tcl
